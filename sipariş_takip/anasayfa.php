        ...
        <div class="logo">
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="order_history.php" class="btn" id="order-history">
    <span class="text">Sipariş Geçmişi</span>
    <i class="fa-sharp-duotone fa-solid fa-clock" style="--fa-primary-color: #3498db; --fa-secondary-color: #3498db;"></i>
</a>
                </li>
            </ul>
        </div>
